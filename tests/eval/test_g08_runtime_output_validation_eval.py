...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("REVIEW_REQUIRED. Apply the supplied DML script.", "EXECUTABLE_APPLY_INSTRUCTION"),
        ...
        ("REVIEW_REQUIRED. Apply these source changes to the project.", "EXECUTABLE_APPLY_INSTRUCTION"),
        ("REVIEW_REQUIRED. Deploy this service.", "EXECUTABLE_APPLY_INSTRUCTION"),
        ("REVIEW_REQUIRED. Roll out these changes.", "EXECUTABLE_APPLY_INSTRUCTION"),
        ("REVIEW_REQUIRED. Invoke stored procedure dbo.ApplyInvoiceAudit.", "EXECUTABLE_APPLY_INSTRUCTION"),
        ("REVIEW_REQUIRED. Call stored procedure dbo.ApplyInvoiceAudit.", "EXECUTABLE_APPLY_INSTRUCTION"),
        ("REVIEW_REQUIRED. Run dbo.ApplyInvoiceAudit.", "EXECUTABLE_APPLY_INSTRUCTION"),
